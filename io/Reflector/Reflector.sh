...
# MaxSupply: hard cap on per-issue supply. Derived in
#   test/ReflectorFork.t.sol::test_MaxSupplyAtV4Cap as the largest
#   amount that fits V4's maxLiquidityPerTick at tickSpacing=1
#   (9587157493047460367638124612 ≈ 9.587e27); a touch below that
#   for a safety margin.
set -euo pipefail
