...
A contract or interface's NatSpec should not mention other contracts unless that contract must know about them (i.e. imports them or its public surface references them). Lower-level pieces in particular should never name their callers — Fountain shouldn't mention Unispring or Reflector; IPlacer shouldn't name "factories like Reflector" as the reason it exists.
